...
export namespace CostAnalyzer {
    export function analyze<T extends object, A extends string>(
    ...
    export class Result<T extends object, A extends string> {
        // @internal
        constructor(workload: Required<Workload<T, A>>, estimates: Estimate<A>[]);
        csv(): string;
...
export class PersistentCache {
    ...
    clear({ leaveEmptyDir }?: { leaveEmptyDir?: boolean | undefined }): Promise<void>;
    readonly dir: string;
    ...
    set(
        key: string,
        value: Buffer | string | Uint8Array | Readable | Blob_2
    ): Promise<void>;
}
