...
|  [validateSerialization](./faastjs.commonoptions.validateserialization.md) | boolean | Check arguments and return values from cloud functions are serializable without losing information. Default: true. |
